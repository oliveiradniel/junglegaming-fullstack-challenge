...
import type { Task, TaskAuditLog } from '@challenge/shared';
import { Link } from '@tanstack/react-router';

export function TaskCreateAuditLogTable({
  taskAuditLogs,
  deletedTaskIds,
}: {
  ...
  return (
    <Table>
      ...
      <TableBody>
        {taskAuditLogs.map(({ taskId, taskTitle, newValue, changedAt }) => {
                ...
                <Popover>
                  ...
                  <PopoverContent>
                    <div className="flex flex-col">
                      ...
                      <span className="text-sm">
                        Prazo para término: {formatDateToBR(taskData?.term!)}
                      </span>
                      ...
                      <div className="mt-2 flex items-center gap-2">
                        <span
                          className={cn(
                            ...
                            taskData?.priority === 'MEDIUM' && 'bg-blue-400',
                            taskData?.priority === 'HIGH' && 'bg-yellow-400',
                            taskData?.priority === 'URGENT' && 'bg-red-400',
                          )}
                        >
                          {priorityLabels[taskData.priority as TaskPriority]}
                        </span>
                        ...
                        <span
                          className={cn(
                            ...
                            taskData?.status === 'IN_PROGRESS' && 'bg-blue-400',
                            taskData?.status === 'REVIEW' && 'bg-purple-400',
